...
movie_genre = MovieGenre.create({ movie_id: 2, genre_id: 3 })
movie_genre = MovieGenre.create({ movie_id: 2, genre_id: 4 })
movie_genre = MovieGenre.create({ movie_id: 3, genre_id: 2 })
movie_genre = MovieGenre.create({ movie_id: 3, genre_id: 4 })
movie_genre = MovieGenre.create({ movie_id: 4, genre_id: 3 })
movie_genre = MovieGenre.create({ movie_id: 4, genre_id: 5 })
movie_genre = MovieGenre.create({ movie_id: 5, genre_id: 5 })
movie_genre = MovieGenre.create({ movie_id: 5, genre_id: 4 })
movie_genre = MovieGenre.create({ movie_id: 5, genre_id: 3 })
